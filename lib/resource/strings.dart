class Strings {
  ...
  static final name = '''Haadiya.'''; // add . at the end
  static final whatIdo = '''I build things for the mobile/web.'''; // add . at the end
  static final introAbout =
      '''I turn ideas into reality.  As a Flutter developer with a deep understanding of UI/UX principles, I build user-centric mobile apps that are not only visually appealing but also efficient and scalable. I use Flutter's features to create seamless, performant applications that bring your vision to life.''';

  /* About screen contents */
  static final aboutPara1 =
      '''My interest with designing user interfaces (UI) led me to the world of mobile app development. I enhanced my Flutter app development skills through self-directed learning, driven by a passion to create user-centric apps.''';
  static final aboutPara2 =
      '''My dedication to learning translated into hands-on experience. I've actively developed projects that have established my knowledge of state management, key Flutter concepts, and problem solving.  This solid foundation allows me to face issues with confidence and produce effective solutions.''';
  ...
  static final techIntro = '''Here are some core Flutter areas I've been focusing on recently:''';
  static final tech1 = ''' Bloc'''; // space for manual padding
  static final tech2 = ''' Provider'''; // space for manual padding
  static final tech3 = ''' GetX'''; // space for manual padding
  static final tech4 = ''' Firebase'''; // space for manual padding
  ...
  static final endTxt =
      '''Although I’m looking forward to any new opportunities, my inbox is always open. Whether you have a question or just want to say hi, I’ll try my best to get back to you!''';
}
