                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            child: InkWell(
                              onTap: () async {
                                await launchUrl(Uri.parse("https://github.com/haadiyaa"));
                              },
                              onHover: (bol) {
                                if (bol) {
                          ...
                          Container(
                            ...
                            child: InkWell(
                              onTap: () async {
                                await launchUrl(Uri.parse("https://www.linkedin.com/in/haadiya-ct-47775621b/"));
                              },
                              onHover: (bol) {
                                if (bol) {
                          ...
                          Container(
                            ...
                            child: InkWell(
                              onTap: () async {
                                await launchUrl(Uri.parse("https://stackoverflow.com/users/22827502/hadiya-sadiq"));
                              },
                              onHover: (bol) {
                                if (bol) {
